...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
  ...
  (500 >> 1),         /*MaxPower 500 mA: this current is used for detecting Vbus*/
  
  /************** Descriptor of Joystick Custom interface ****************/
  /* 09 */
  ...
  HID_EPIN_SIZE, /*wMaxPacketSize: Byte max */
  0x00,
  HID_FS_BINTERVAL,          /*bInterval: Polling Interval (ms)*/
  /* 34 */
  0x07,          /*bLength: Endpoint Descriptor size*/
  USB_DESC_TYPE_ENDPOINT, /*bDescriptorType:*/
  ...
  0x03,          /*bmAttributes: Interrupt endpoint*/
  HID_EPOUT_SIZE, /*wMaxPacketSize: Byte max */
  0x00,
  HID_FS_BINTERVAL,          /*bInterval: Polling Interval (ms)*/
  /* 41 */
} ;
